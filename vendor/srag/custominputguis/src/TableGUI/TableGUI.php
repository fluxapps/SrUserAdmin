...
namespace srag\CustomInputGUIs\SrUserAdmin\TableGUI;

use ilCSVWriter;
use ilExcel;
use ilFormPropertyGUI;
use ilTable2GUI;
use srag\CustomInputGUIs\SrUserAdmin\PropertyFormGUI\Items\Items;
use srag\CustomInputGUIs\SrUserAdmin\PropertyFormGUI\PropertyFormGUI;
use srag\CustomInputGUIs\SrUserAdmin\TableGUI\Exception\TableGUIException;
use srag\DIC\SrUserAdmin\DICTrait;

/**
 * Class TableGUI
 *
 * @package srag\CustomInputGUIs\SrUserAdmin\TableGUI
 *
